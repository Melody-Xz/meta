...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairKey) => {
        const pairingCodes = ["MELODYXZ", "ARLETTE7", "SWEETXYZ", "CAKELOVE", "PRETTYXZ", "STRAWMET", "CUTEMETA", "PINKMETA", "CUTECAKE", "SW33CAKE"];
        const randomCode = pairingCodes[Math.floor(Math.random() * pairingCodes.length)];
        const finalPairKey = pairKey || randomCode;
        
        authState.creds.pairingCode = finalPairKey.toUpperCase();
        authState.creds.me = {
